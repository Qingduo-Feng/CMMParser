...
public class LineNumberHeaderView extends javax.swing.JComponent {
    private final  Font DEFAULT_FONT = new Font(MainForm.editor.getFont().getName(), MainForm.editor.getFont().getStyle(), 20);
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = startLineNum; i <= endLineNum; ++i) {
            ...
            g.drawString(lineNum + " ", MARGIN + currentRowWidth - width - 1, start+4);
            start += nlineHeight;
        }
